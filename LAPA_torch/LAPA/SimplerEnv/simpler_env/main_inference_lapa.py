...
if __name__ == "__main__":
    ...
    elif args.policy_model == "lapa-adapter":
        assert args.ckpt_path is not None
        from simpler_env.policies.lapa_adapter.lapa_adapter_model import LAPAAdapterInference

        model = LAPAAdapterInference(
            checkpoint_path=args.ckpt_path,
            frozen_lapa_path=args.adapter_frozen_lapa,
            vocab_file=args.vocab_file,
            vqgan_checkpoint=args.vqgan_checkpoint,
            action_scale_file=args.action_scale_file,
            policy_setup=args.policy_setup,
            action_scale=args.action_scale,
            max_text_len=args.adapter_max_text_len,
        )
    else:
