...
def get_args():
    ...
    parser.add_argument("--adapter-frozen-lapa", type=str, default="../adapter_distill/artifacts/lapa_frozen.npz")
    parser.add_argument("--adapter-max-text-len", type=int, default=128)
    ...
    parser.add_argument("--load-llama-config", type=str, default="")
    parser.add_argument("--update-llama-config", type=str, default="")
    parser.add_argument("--tokens-per-delta", type=int, default=1)
    parser.add_argument("--tokens-per-action", type=int, default=0)
    parser.add_argument("--vocab-file", type=str, default=None)
    parser.add_argument("--multi_image", type=int, default=1)
    parser.add_argument("--jax-distributed", type=dict, default=JaxDistributedConfig.get_default_config())
    parser.add_argument("--delta-actions", type=bool, default=True)
    parser.add_argument("--cont-action", type=bool, default=False)
    ...
    parser.add_argument("--indi-task", type=str, default=None)
